...
vMesh_notex::vMesh_notex() {}

vMesh_notex::vMesh_notex(std::vector<vertex> vertices, std::vector<unsigned int> indices) 
	: vertices(vertices), indices(indices) {

	setUp();
}

void vMesh_notex::render(shader Shader) {
