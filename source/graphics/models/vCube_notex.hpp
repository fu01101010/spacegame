#ifndef VCUBE_NOTEX_HPP
#define VCUBE_NOTEX_HPP

#include "vModel_notex.h"
#include "../material.h"

class vCube_notex : public vModel_notex {
...
public:
	...
	vCube_notex() {}
	vCube_notex(material Material, glm::vec3 position, glm::vec3 size) 
	...
	void init() {
		...
		vMeshes.push_back(vMesh_notex(vertex::genList(vertices, nVertices), indices));
	}
