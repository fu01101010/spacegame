...
int main()
{
	...
	// lights
	mDirectLight DirectLight = { glm::vec3(-0.2f, -1.0f, -0.3f), glm::vec4(0.1f, 0.1f, 0.1f, 1.0f), glm::vec4(0.4f, 0.4f, 0.4f, 1.0f), glm::vec4(0.5f, 0.5f, 0.5f, 1.0f) };
...
>>>>>>> 528a8ee5ae6310d1daa5483bac7eb887feeaa601
	...
	vLightSource lamp = vLightSource(glm::vec3(1.0f), glm::vec3(0.05f), glm::vec3(0.8f), glm::vec3(1.0f), glm::vec3(1.0f, 0.07f, 0.032f), glm::vec3(0.0f, 0.0f, 3.0f), glm::vec3(0.25f));
	lamp.init();
